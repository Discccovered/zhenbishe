            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li class="active"><button type="button" class="btn btn-link  navbar-btn" id="shouye" >首页<span class="sr-only">(current)</span></button></li>
                        <li><button type="button" class="btn btn-link  navbar-btn" id="guanyuyangsheng" >关于养生</button></li>
                        <li><a href="#">养生天地</a></li>
                        <li><a href="#">新闻动态</a></li>
                        <li><a href="#">养生保健</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">四季养生 <span class="caret"></span></a>
...
<div class="row b-col-default-indent">
    <div class="col-md-12">
        <div class="b-categories-filter">
            <h4 class="f-primary-b b-h4-special f-h4-special--gray f-h4-special">当前在线</h4>
            <ul>
    <li>
    ...
    <div class="col-md-12">
        <h4 class="f-primary-b b-h4-special  f-h4-special--gray f-h4-special">热门文章</h4>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title" id="myModalLabel">注册账号信息</h3>
				</div>
				<div class="modal-body">

				<form action="" method="post" enctype="multipart/form-data">
					<!-- <div>
						<label for="id">用户编号:：</label><span id="id">12345678</span>
					</div> -->
